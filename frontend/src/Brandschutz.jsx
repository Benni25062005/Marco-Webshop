    ...
    return(<>
        ...
        <main>
            <div className="flex justify-center mt-24">
                <div className="flex flex-col md:flex-row lg:space-x-24 md:space-x-16">
                    ...
                    <div className="flex flex-col max-w-2xl md:max-w-2xl mx-auto space-y-2 md:space-y-4 p-4 sm:p-6 md:p-8" >
                        <h2 className="lg:text-4xl md:text-2xl sm:text-xl  font-bold">Brandschutz - Beratung, Produkte & Service</h2>

                        <p className="text-base sm:text-lg md:text-xl leading-relaxed text-justify sm:text-left ">
                            Als Kaminfeger ist Brandschutz seit jeher Teil unserer Arbeit. Ab sofort bieten wir zusätzlich professionelle Beratung, Verkauf und Wartung von Feuerlöschern, Löschdecken und Rauchmeldern an – alles aus einer Hand.
                        </p>

                        <p className="text-base sm:text-lg md:text-xl leading-relaxed text-justify sm:text-left">
                           Wir setzen auf fluorfreie Feuerlöscher ohne PFAS – umweltfreundlich und zukunftssicher, denn in der EU sind diese Stoffe bereits verboten. 
                        </p>

                        <p className="text-base sm:text-lg md:text-xl leading-relaxed text-justify sm:text-left">
                            Gerne besichtigen wir Ihre Liegenschaft in der Region Buchs SG und beraten Sie zu geeigneten Löschmitteln und deren optimaler Platzierung. Auch die Wartung Ihrer Feuerlöscher übernehmen wir – empfohlen alle drei Jahre.
                        </p>

                        <p className="text-base font-semibold sm:text-lg md:text-xl leading-relaxed text-justify sm:text-left">
                            Brandschutz, der schützt - für Sicherheit, Umwelt und klare Vorschriften.
                        </p>
            ...
            <section className="max-w-6xl mx-auto px-4 py-16 mt-24">
                <h2 className="text-4xl font-bold text-center mb-12">Unsere Leistungen im Überblick</h2>
            ...
            <section className="max-w-4xl mx-auto px-4 py-12">
                ...
                <p className="text-lg text-gray-800 leading-relaxed mb-6">
                    Als Kaminfeger ist Brandschutz ein fester Bestandteil unserer Arbeit.
                    Ab sofort bieten wir umfassende Dienstleistungen in diesem Bereich an:
                    individuelle Beratung, Verkauf von Feuerlöschern, Löschdecken und
                    Rauchmeldern – sowie deren Wartung.
                </p>

                <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded-md mb-6">
                    <p className="text-sm text-red-800">
                    Unsere fluorfreien Feuerlöscher enthalten kein PFAS. Diese „ewigen
                    Chemikalien“ sind in der EU seit 2024 verboten – auch in der Schweiz
                    steht ein Verbot bevor.
                    </p>
                </div>
                ...
                <p className="text-base text-gray-700 mb-6">
                    ...
                    Auch die empfohlene Wartung alle drei Jahre übernehmen wir zuverlässig.
                </p>
