...
import { requestReset } from "../../../features/auth/authSlice";
...
export default function ResetPasswortModal({ isOpen, onClose }) {
  ...
  return (
    <>
      {step === 3 ? (
        <ChangePasswordModal email={email} code={code} onClose={onClose} />
      ) : (
              ...
              {step === 1 ? (
                ...
                <>
                  ...
                  <p className="text-md mb-6">
                    Wir haben Ihnen einen Bestätigungscode geschickt!
                  </p>
                </>
              )}
            </div>
