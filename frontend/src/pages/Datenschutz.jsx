...
export default function Datenschutz() {
  return (
    <>
      <Helmet>
        <title>Datenschutzerklärung | Kaminfeger Knapp</title>
        <meta
          name="description"
          content="Informationen zum Datenschutz bei Kaminfeger Knapp: Umgang mit personenbezogenen Daten, Cookies, Analyse-Tools und Ihren Rechten als betroffene Person."
        />
      </Helmet>
      ...
      <main className="min-h-screen ">
        <div className="mx-auto max-w-4xl px-4 py-10">
          <div className=" bg-white p-6  sm:p-10">
            <article className="prose prose-gray max-w-none prose-h1:mt-0 prose-h2:mt-10 prose-h3:mt-6 prose-a:break-words">
              ...
              <p>
                Telefon: +41 79 814 81 32
                <br />
                E-Mail: kaminfeger-knapp@gmx.ch
              </p>
              <p>
              ...
              <p>
                Sie können sich auf dieser Website registrieren, um ein
                Nutzerkonto anzulegen und bestimmte Funktionen (z.&nbsp;B.
                Bestellungen, Bestellhistorie) nutzen zu können. Dabei
                verarbeiten wir die von Ihnen angegebenen Daten (z.&nbsp;B.
                Name, E-Mail-Adresse, ggf. Adresse und weitere Kontodaten).
              </p>
              <p>
                Die Verarbeitung erfolgt zur Durchführung vorvertraglicher
                Maßnahmen bzw. zur Vertragserfüllung (Art. 6 Abs. 1 lit. b
                DSGVO). Sofern Sie freiwillige Angaben machen, erfolgt die
                Verarbeitung ggf. auf Grundlage Ihrer Einwilligung (Art. 6 Abs.
                1 lit. a DSGVO).
              </p>
              <p>
                Die im Rahmen der Registrierung erhobenen Daten werden
                gespeichert, solange Ihr Nutzerkonto besteht. Sie können Ihr
                Nutzerkonto jederzeit löschen lassen, sofern keine gesetzlichen
                Aufbewahrungspflichten entgegenstehen.
              </p>
              <h2>6. Kundenkonto</h2>
              <p>
                Wenn Sie ein Kundenkonto anlegen, speichern wir die dafür
                erforderlichen Daten, damit Sie bei zukünftigen Bestellungen
                nicht alle Daten erneut eingeben müssen. Die in Ihrem
                Kundenkonto gespeicherten Daten können Sie jederzeit einsehen
                und ändern.
              </p>
              <p>
              ...
              <h2>7. Verarbeitung von Kunden- und Vertragsdaten</h2>
              <p>
                Wir erheben, verarbeiten und nutzen personenbezogene Daten,
                soweit diese für die Begründung, inhaltliche Ausgestaltung oder
                Änderung eines Vertragsverhältnisses erforderlich sind
                (Bestandsdaten) sowie zur Abwicklung von Bestellungen,
                Lieferungen und Leistungen (Vertragsdaten).
              </p>
              <p>Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO.</p>
              <h2>
                8. Datenübermittlung bei Vertragsschluss für Online-Shops,
                Händler und Warenversand
              </h2>
              <p>
                Zur Abwicklung Ihrer Bestellung übermitteln wir personenbezogene
                Daten an Dritte, soweit dies zur Vertragserfüllung erforderlich
                ist. Hierzu zählen insbesondere Versand- und
                Logistikdienstleister (zur Zustellung) sowie ggf. weitere
                Dienstleister, die wir zur Abwicklung der Bestellung einsetzen.
              </p>
              <p>
                Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO. Eine darüber
                hinausgehende Übermittlung erfolgt nur, wenn wir hierzu
                gesetzlich verpflichtet sind oder Sie eingewilligt haben.
              </p>
              <h2>9. Zahlungsdienste (Worldline)</h2>
              <p>
                Zur Abwicklung von Zahlungen setzen wir den
                Zahlungsdienstleister Worldline ein. Wenn Sie eine Zahlung über
                Worldline durchführen, werden die für den Zahlungsvorgang
                erforderlichen Daten an Worldline übermittelt bzw. von Worldline
                verarbeitet.
              </p>
              <p>
                Dabei kann es sich insbesondere um Bestandsdaten (z.&nbsp;B.
                Name), Kontaktdaten (z.&nbsp;B. E-Mail-Adresse), Vertrags- und
                Zahlungsdaten (z.&nbsp;B. Betrag, Zahlungsstatus,
                Transaktionsdetails) handeln. Zahlungsdaten (z.&nbsp;B.
                Karten-/Kontodaten) werden in der Regel direkt von Worldline
                verarbeitet und nicht von uns gespeichert.
              </p>
              <p>
                Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO
                (Vertragserfüllung), da die Übermittlung zur Abwicklung der
                Zahlung erforderlich ist.
              </p>
              <p>
                Weitere Informationen zur Datenverarbeitung durch Worldline
                entnehmen Sie bitte den Datenschutzhinweisen von Worldline.
              </p>
              <h2>10. Cloudflare</h2>
              <p>
                Wir nutzen Cloudflare als Content Delivery Network (CDN) und zur
                Absicherung unserer Website (z.&nbsp;B. Schutz vor
                DDoS-Angriffen, Beschleunigung der Auslieferung). Dabei können
                technische Daten (insbesondere IP-Adressen) in Server-Logfiles
                verarbeitet werden.
              </p>
              <p>
                Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
                DSGVO (berechtigtes Interesse an einer sicheren, stabilen und
