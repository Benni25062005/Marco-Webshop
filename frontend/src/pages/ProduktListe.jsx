    ...
    return (<>
        ...
        {showFilter && (
            ...
            >
                ...
                <button
                    onClick={() => {setSelected(tempSelected); setShowFilter(false); toast.success("Filter angewendet")}}
        ...
        <div className="flex flex-col pt-44 pb-24 text-center">
            <div className="flex flex-col space-y-2">
                ...
                >
                    Alle Produkte</motion.h1>
                <motion.h2 
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className="text-4xl md:text-6xl font-bold">auf einen Blick</motion.h2>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-24 gap-x-12 mt-24 justify-items-center px-4 sm:px-8 md:px-16 lg:px-32 xl:px-64">
          {Array.isArray(items) ? (
            items
