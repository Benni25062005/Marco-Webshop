...
export default function Main() {
    ...
    if (!selectedItem) {
        return <p className="text-center mt-10 text-3xl">Feuerlöscher nicht gefunden</p>
    }

    return (<>

        <div className="flex justify-center mt-14 gap-x-16 sm:pl-4">
            <img className="h-[28rem] md:h-[36rem] lg:h-[40rem] border-2 border-red-600 rounded-xl p-16 " src={selectedItem.Bild}></img> 
            ...
            <div className="max-w-2xl md:max-w-3xl lg:max-w-md ">
                ...
                <div id="counter" className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-4">
